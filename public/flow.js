...
var SIMULATION_FRAGMENT_SHADER_SOURCE = [
    ...
    'void main () {',
        ...
        'if (newLifetime < 0.0) {',
            'newPosition = spawnData.rgb + u_abs_pos;',
...
var Camera = function (element) {
    ...
    element.addEventListener('mousemove', function (event) {
      // absPos.x = - (event.x / WIDTH) * 4;
      // absPos.y = - (event.y / HEIGHT - 0.5) * 2;
...
var Flow = function (canvas) {
    ...
    var render = function render (currentTime) {
        ...
        for (var i = 0; i < (firstFrame ? BASE_LIFETIME / PRESIMULATION_DELTA_TIME : 1); ++i) {
            ...
            gl.uniform3f(simulationProgramWrapper.uniformLocations['u_abs_pos'], absPos.x, absPos.y, absPos.z);
